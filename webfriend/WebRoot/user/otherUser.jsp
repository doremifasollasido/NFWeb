...
<div class="span3 sider" style="margin-right:0px;">
  <ul style="list-style:none; border-bottom:1px solid #eaeaea;padding-bottom:35px">
    <li>
      <center>
...
<div class="span9 friendMain">
        <h3>　<i class="icon-user" style="margin-top:10px"></i>　{姓名}</h3>
<a style="margin-left:20px;" class="btn btn-small btn-success" href="##">加为好友</a>
<div class="line"></div>

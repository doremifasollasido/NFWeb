...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-inbox"></i></a>
  <ul>
    ...
    <li class="active"> <a href="charts.html"><i class="icon icon-signal"></i> <span>删除心情</span></a> </li>
      ...
      <div class="widget-content nopadding">
        <ul class="recent-posts">
          <li>
            ...
            <div class="article-post"> <span class="user-info"> 发表者: 小名 发表时间：2014/9/16, 09:27</span>
              <p> <a href="#">今天天气不错...</a> </p>
              <a href="#" class="btn btn-danger btn-mini btn-right">Delete</a> </div>
          </li>
        </ul>
      </div>
    </div>

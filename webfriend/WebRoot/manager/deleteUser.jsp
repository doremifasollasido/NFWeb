...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-inbox"></i></a>
  <ul>
    ...
    <li class="active"> <a href="userdisplay.action"><i class="icon icon-inbox"></i> <span>删除用户</span></a> </li>
  </ul>
</div>
<div id="content">
  ...
  <div id="breadcrumb"> <a href="http://localhost:8080/nf/manager/adminIndex.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">删除用户</a> </div>
            ...
            <tbody>
              <s:iterator value="list" id="User">
                <tr class="gradeX">
                  ...
                  <td class="center"><s:a href="userdelete.action?id=%{#User.id}"  class="tip-top" data-original-title="Delete"><i class="icon-remove"></i></s:a></td>
                </tr>
              </s:iterator>
            </tbody>
          </table>
